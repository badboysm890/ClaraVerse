/**
 * angelaMemoryToastService.tsx
 * 
 * Service to manage angela's memory learning toast notifications.
...
const STORAGE_KEY = 'angela-memory-toast-state';
const KNOWLEDGE_LEVEL_KEY = 'angela-knowledge-level';

// Production mode - debug functionality removed

// ==================== SERVICE CLASS ====================

class angelaMemoryToastService {
...
export const angelaMemoryToastService = new angelaMemoryToastService();
