/**
 * angela Assistant Artifact Renderer
 * 
 * This component handles rendering of various artifact types generated by angela,
...
export type EnhancedArtifactType = angelaArtifactType | 
 ...
 */
const InteractiveChartRenderer: React.FC<{ content: string; artifact: angelaArtifact; onFullScreen?: () => void }> = ({ content, artifact, onFullScreen }) => {
...
/**
 * Main angela Artifact Renderer Component
 */
const angelaArtifactRenderer: React.FC<angelaArtifactRendererProps> = ({
  artifact,
  isExpanded = false,
  onToggleExpanded,
  onCopy,
  ...
  const getContentType = (type: angelaArtifactType): string => {
    const types = {
      code: 'text/plain',
      html: 'text/html',
  ...
  const getFileExtension = (type: angelaArtifactType): string => {
    const extensions = {
...
export default angelaArtifactRenderer; 
