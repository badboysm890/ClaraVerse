/**
 * angela Assistant Chat Window Component
 * 
 * This component serves as the main chat interface for the angela assistant.
...
import { 
  angelaMessage, 
  angelaChatWindowProps,
  angelaProcessingState
} from '../../types/angela_assistant_types';
import angelaMessageBubble from './angela_assistant_message_bubble';
      ...
      <div className="max-w-2xl text-center">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-3">
            Welcome{userName ? ` back, ${userName}` : ''} to angela! 
        ...
        <div className="text-sm text-gray-500 dark:text-gray-400">
          ...
          <p>
            🔄 angela automatically detects file types and uses the best AI models for each task.
          </p>
        </div>
      </div>
    </div>
...
/**
 * Loading screen component displayed when angela is initializing
 */
    ...
    <div className="flex items-center justify-center h-full p-8">
      <div className="max-w-md text-center">
        ...
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">
          Initializing angela... (Updating Backend & Loading Models)
        </h2>
...
const ProcessingIndicator: React.FC<{
  processingState: angelaProcessingState;
  message?: string;
    ...
    switch (processingState) {
      case 'processing':
        return {
          ...
          text: message || 'angela is thinking...',
          bgColor: 'bg-blue-500'
        };
      case 'success':
        return {
...
/**
 * Main angela Chat Window Component
 */
const angelaChatWindow: React.FC<angelaChatWindowProps> = ({
  messages,
  userName,
  isLoading = false,
  ...
  const [processingState, setProcessingState] = useState<angelaProcessingState>('idle');
  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto">
        {/* Loading screen when angela is initializing */}
        {isInitializing ? (
...
export default angelaChatWindow; 
